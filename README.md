...
- 幼儿版：少文字、大图卡、大方框导航；今天、花园战场、成长、打卡、语数英课程、改错、奖励、家长和设置。2.0 方块花园首页复现暑期作业台的六项任务总览、阳光、宝箱、收集栏和花园战况；独立花园战场页提供玩法说明、守护记录和植物伙伴选择，奖励中心按四层组织，完成任务获得豌豆能量，可召唤友好小怪并在三路六列棋盘发射豌豆防守。v0.3.1 为 21 个课程练习增加图形化选项和课程进度条，首页提供继续学习入口，答对后才会点亮课程并发放原有奖励；继续保留 441/390px 三列、320px 两列状态卡和无横向滚动，设置页可选花园音乐、动效和语音夸奖。
