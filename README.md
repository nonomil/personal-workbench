...
- 幼儿版：少文字、大图卡、大方框导航；今天、花园战场、成长、打卡、语数英课程、改错、奖励、家长和设置。2.0 方块花园首页复现暑期作业台的六项任务总览、阳光、宝箱、收集栏和花园战况；独立花园战场页提供玩法说明、守护记录和植物伙伴选择，奖励中心按四层组织，完成任务获得豌豆能量，可召唤友好小怪并在三路六列棋盘发射豌豆防守。v0.3.3 在课程成长路线之上增加“今日行动路线”：首页把今日打卡、继续学习、奖励/植物大战串成三步入口；课程侧栏显示每个专区的进度条和准备/继续/已点亮状态。答对后才会点亮课程并发放原有奖励，继续保留 441/390px 三列、320px 两列状态卡和无横向滚动，设置页可选花园音乐、动效和语音夸奖。
