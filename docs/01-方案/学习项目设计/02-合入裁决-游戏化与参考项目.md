...
> 核验日期：2026-08-14  
> 源文档：`14-调研-workbuddy课件工作流.md`（原 `workbuddy游戏化学习.md`）、`13-调研-学习游戏参考项目.md`（原 `DS--学习游戏--参考项目.md`）  
> 历史文件名：`DS--游戏化学习--设计方案.md`（2026-08-15 编号整理时改名）  
> 克隆落点：`docs/01-方案/学习项目设计/refs/`（已 gitignore，不进发布树、不进 `prj/`）  
> 本文是合入裁决，不是“已实现”。
...
`13-调研-学习游戏参考项目.md`（原 `DS--学习游戏--参考项目.md`）里这几句需要改口径：
...
5. 本文（原文件名 `DS--游戏化学习--设计方案.md`）原先是空文件；后补成合入方案。
