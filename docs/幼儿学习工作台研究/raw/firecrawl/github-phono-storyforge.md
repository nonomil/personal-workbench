[Skip to content](https://github.com/tanner-griffith/phono-storyforge#start-of-content)

You signed in with another tab or window. [Reload](https://github.com/tanner-griffith/phono-storyforge) to refresh your session.You signed out in another tab or window. [Reload](https://github.com/tanner-griffith/phono-storyforge) to refresh your session.You switched accounts on another tab or window. [Reload](https://github.com/tanner-griffith/phono-storyforge) to refresh your session.Dismiss alert

{{ message }}

[tanner-griffith](https://github.com/tanner-griffith)/ **[phono-storyforge](https://github.com/tanner-griffith/phono-storyforge)** Public

- [Notifications](https://github.com/login?return_to=%2Ftanner-griffith%2Fphono-storyforge) You must be signed in to change notification settings
- [Fork\\
0](https://github.com/login?return_to=%2Ftanner-griffith%2Fphono-storyforge)
- [Star\\
0](https://github.com/login?return_to=%2Ftanner-griffith%2Fphono-storyforge)
...
[**4** Branches](https://github.com/tanner-griffith/phono-storyforge/branches) [**0** Tags](https://github.com/tanner-griffith/phono-storyforge/tags)

[Go to Branches page](https://github.com/tanner-griffith/phono-storyforge/branches)[Go to Tags page](https://github.com/tanner-griffith/phono-storyforge/tags)
...
| --- | --- | --- | --- |
| ## Latest commit<br>![tanner-griffith](https://avatars.githubusercontent.com/u/268463832?v=4&size=40)![claude](https://avatars.githubusercontent.com/u/81847?v=4&size=40)<br>[tanner-griffith](https://github.com/tanner-griffith/phono-storyforge/commits?author=tanner-griffith)<br>and<br>[claude](https://github.com/tanner-griffith/phono-storyforge/commits?author=claude)<br>[Subset the web fonts; refresh demo data; collect Kaggle docs](https://github.com/tanner-griffith/phono-storyforge/commit/8010335668a13abdea9427b59c81835e0b0e4313)<br>Open commit details<br>5 days agoJul 28, 2026<br>[8010335](https://github.com/tanner-griffith/phono-storyforge/commit/8010335668a13abdea9427b59c81835e0b0e4313) · 5 days agoJul 28, 2026<br>## History<br>[40 Commits](https://github.com/tanner-griffith/phono-storyforge/commits/main/) <br>Open commit details<br>[View commit history for this file.](https://github.com/tanner-griffith/phono-storyforge/commits/main/) 40 Commits |
| [.phono-demo-data](https://github.com/tanner-griffith/phono-storyforge/tree/main/.phono-demo-data ".phono-demo-data") | [.phono-demo-data](https://github.com/tanner-griffith/phono-storyforge/tree/main/.phono-demo-data ".phono-demo-data") |  |  |
| [app](https://github.com/tanner-griffith/phono-storyforge/tree/main/app "app") | [app](https://github.com/tanner-griffith/phono-storyforge/tree/main/app "app") |  |  |
| [archive](https://github.com/tanner-griffith/phono-storyforge/tree/main/archive "archive") | [archive](https://github.com/tanner-griffith/phono-storyforge/tree/main/archive "archive") |  |  |
| [artifacts/media](https://github.com/tanner-griffith/phono-storyforge/tree/main/artifacts/media "This path skips through empty directories") | [artifacts/media](https://github.com/tanner-griffith/phono-storyforge/tree/main/artifacts/media "This path skips through empty directories") |  |  |
| [docs](https://github.com/tanner-griffith/phono-storyforge/tree/main/docs "docs") | [docs](https://github.com/tanner-griffith/phono-storyforge/tree/main/docs "docs") |  |  |
| [eval](https://github.com/tanner-griffith/phono-storyforge/tree/main/eval "eval") | [eval](https://github.com/tanner-griffith/phono-storyforge/tree/main/eval "eval") |  |  |
| [results/sample\_book](https://github.com/tanner-griffith/phono-storyforge/tree/main/results/sample_book "This path skips through empty directories") | [results/sample\_book](https://github.com/tanner-griffith/phono-storyforge/tree/main/results/sample_book "This path skips through empty directories") |  |  |
| [scripts](https://github.com/tanner-griffith/phono-storyforge/tree/main/scripts "scripts") | [scripts](https://github.com/tanner-griffith/phono-storyforge/tree/main/scripts "scripts") |  |  |
| [tests](https://github.com/tanner-griffith/phono-storyforge/tree/main/tests "tests") | [tests](https://github.com/tanner-griffith/phono-storyforge/tree/main/tests "tests") |  |  |
| [.gitignore](https://github.com/tanner-griffith/phono-storyforge/blob/main/.gitignore ".gitignore") | [.gitignore](https://github.com/tanner-griffith/phono-storyforge/blob/main/.gitignore ".gitignore") |  |  |
| [DESIGN\_GUIDELINES.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/DESIGN_GUIDELINES.md "DESIGN_GUIDELINES.md") | [DESIGN\_GUIDELINES.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/DESIGN_GUIDELINES.md "DESIGN_GUIDELINES.md") |  |  |
| [Dockerfile](https://github.com/tanner-griffith/phono-storyforge/blob/main/Dockerfile "Dockerfile") | [Dockerfile](https://github.com/tanner-griffith/phono-storyforge/blob/main/Dockerfile "Dockerfile") |  |  |
| [GEMINI.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/GEMINI.md "GEMINI.md") | [GEMINI.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/GEMINI.md "GEMINI.md") |  |  |
| [LICENSE](https://github.com/tanner-griffith/phono-storyforge/blob/main/LICENSE "LICENSE") | [LICENSE](https://github.com/tanner-griffith/phono-storyforge/blob/main/LICENSE "LICENSE") |  |  |
| [README.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/README.md "README.md") | [README.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/README.md "README.md") |  |  |
| [agents-cli-manifest.yaml](https://github.com/tanner-griffith/phono-storyforge/blob/main/agents-cli-manifest.yaml "agents-cli-manifest.yaml") | [agents-cli-manifest.yaml](https://github.com/tanner-griffith/phono-storyforge/blob/main/agents-cli-manifest.yaml "agents-cli-manifest.yaml") |  |  |
| [pyproject.toml](https://github.com/tanner-griffith/phono-storyforge/blob/main/pyproject.toml "pyproject.toml") | [pyproject.toml](https://github.com/tanner-griffith/phono-storyforge/blob/main/pyproject.toml "pyproject.toml") |  |  |
| [uv.lock](https://github.com/tanner-griffith/phono-storyforge/blob/main/uv.lock "uv.lock") | [uv.lock](https://github.com/tanner-griffith/phono-storyforge/blob/main/uv.lock "uv.lock") |  |  |
| View all files |
...
[Permalink: Phono StoryForge](https://github.com/tanner-griffith/phono-storyforge#phono-storyforge)

![License: Apache 2.0](https://camo.githubusercontent.com/798509b4df525f56802b56f8096862487f08023e3d7561c68656f8dab10d0d6e/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f6c6963656e73652d4170616368652d2d322e302d626c75652e737667)![Python 3.11+](https://camo.githubusercontent.com/b53facf22983aa2d774dc86c7382e9d08096b26bd96bc2d83e6885a50bacea85/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f707974686f6e2d332e31312532422d626c75652e737667)

Phono StoryForge is a **closed-loop adaptive reading tutor** for early and struggling readers (dyslexia-aware), built on Google's Agent Development Kit (ADK). It doesn't just generate a decodable storybook once — it keeps a per-child mastery model, decides what phonics skill to teach next from that child's own reading evidence, generates a book guaranteed decodable at exactly that level, listens to the child read it, attributes every miscue down to the specific grapheme, updates the mastery model, and lets the _next_ book change because of how this read went.
...
[Permalink: The Problem](https://github.com/tanner-griffith/phono-storyforge#the-problem)

Parents of dyslexic and struggling readers are told to "read decodable books at their level," but (1) decodable books at the _exact_ combination of phonics level + interests + age a given child needs are scarce and generic, and (2) nothing adapts: there's no loop that watches what the child actually misreads and chooses what to practice next. Phono StoryForge closes that loop — content generation guaranteed decodable for _this_ child, plus an evidence-driven tutor that targets their real gaps and adapts session over session.

## The thesis: a closed loop, not a one-shot generator

[Permalink: The thesis: a closed loop, not a one-shot generator](https://github.com/tanner-griffith/phono-storyforge#the-thesis-a-closed-loop-not-a-one-shot-generator)
...
next session's target has shifted
...
**The same code that runs the product loop is the code the evidence experiment exercises** (see _Evidence_ below) — so the simulation isn't a detached toy; it's a calibration/regression harness for the production brain.

## Status (honest)

[Permalink: Status (honest)](https://github.com/tanner-griffith/phono-storyforge#status-honest)

[![The live web app's onboarding screen](https://github.com/tanner-griffith/phono-storyforge/raw/main/artifacts/media/web-app-screenshot.png)](https://github.com/tanner-griffith/phono-storyforge/blob/main/artifacts/media/web-app-screenshot.png)_The onboarding screen of the live web app (`scripts/tutor_web.py`) — the same real UI the loop below runs in, screenshotted from a running instance, not a mockup._
...
- **What's honestly not done.** A self-improving content flywheel — every real session becomes an eval datapoint, with `check_decodability` as an always-on judge (roadmap item **D′**) — is planned but not built. The de-circularized evidence study (Stage D) is done; see _Evidence_. **The full offline `tests/unit` suite passes** (`uv run pytest tests/unit`).

## The content engine: verifier-gated decodable-book generation

[Permalink: The content engine: verifier-gated decodable-book generation](https://github.com/tanner-griffith/phono-storyforge#the-content-engine-verifier-gated-decodable-book-generation)
...
(deterministic check\_decodability)

Finalized Story

Illustrator: Nano Banana art

\+ palette verifier

Docs/Drive export (MCP)

Gmail parent report (MCP)
...
- **Brand-consistent illustration (propose/verify guardrail):** a per-book character bible + **Nano Banana** (`gemini-2.5-flash-image`, via Vertex) render each page; a **deterministic palette verifier** (`app/skills/palette_verifier.py`) proves every image stays on the brand palette defined in `app/brand.py` — the same propose/verify pattern as the phonics gate. Real images are embedded inline in the Doc, with a dyslexia-friendly body typeface for legibility. _(The specific palette and illustration style are implementation values currently in app/brand.py and are being reworked in a visual identity reboot — see DESIGN\_GUIDELINES.md. The guardrail mechanism is identity-independent: it enforces whatever palette brand.py defines.)_
...
[Permalink: Evidence: adaptive beats a fixed sequence](https://github.com/tanner-griffith/phono-storyforge#evidence-adaptive-beats-a-fixed-sequence)
...
[Permalink: Documentation map](https://github.com/tanner-griffith/phono-storyforge#documentation-map)

The deeper write-ups live under [`docs/`](https://github.com/tanner-griffith/phono-storyforge/blob/main/docs):

| Document | What it covers |
| --- | --- |
| [docs/kaggle-writeup-FINAL.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/docs/kaggle-writeup-FINAL.md) | The capstone write-up — problem, architecture, evidence, and the "Agents for Good" case. |
| [docs/stage-d-independent-learner.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/docs/stage-d-independent-learner.md) | Stage D evidence and rigor: the de-circularized independent learner (logistic/IRT emission, no ZPD gate, forgetting) and what the adaptive-vs-static gaps do and don't show. |
| [docs/build-plan.md](https://github.com/tanner-griffith/phono-storyforge/blob/main/docs/build-plan.md) | The staged build plan (A→D′) and the engineering decisions behind each stage. |

## Capstone concepts demonstrated

[Permalink: Capstone concepts demonstrated](https://github.com/tanner-griffith/phono-storyforge#capstone-concepts-demonstrated)
...
[Permalink: Known Limitations](https://github.com/tanner-griffith/phono-storyforge#known-limitations)

Documented honestly rather than glossed over:

- **Illustrated-book generation now reaches the live loop, with graceful degradation rather than a hard failure.** The illustrated-book ADK pipeline (Nano Banana art + Docs export) can be triggered directly from the live per-session loop (web UI), not just as a separate standalone path — see _Status_ above. It degrades along two independent axes instead of failing outright: if illustration generation is unavailable, the result falls back to text-only pages; if Docs export is unavailable, it falls back to illustrated pages without a shareable Doc link.
...
[Permalink: Project Structure](https://github.com/tanner-griffith/phono-storyforge#project-structure)
...
[Permalink: Requirements](https://github.com/tanner-griffith/phono-storyforge#requirements)
...
[Permalink: Setup](https://github.com/tanner-griffith/phono-storyforge#setup)
...
4. **Set up `gws` credentials for real Docs/Drive/Gmail export.** The deterministic export path is PATH-first, so authenticate the `gws` already on your PATH (see _Known Limitations → Two gws postures_). Auth is stored in the default file location (`~/.config/gws`) because the MCP subprocess only inherits a safe-list of env vars.
...
[Permalink: Running it](https://github.com/tanner-griffith/phono-storyforge#running-it)
...
[Permalink: Testing](https://github.com/tanner-griffith/phono-storyforge#testing)
...
[Permalink: Deployment](https://github.com/tanner-griffith/phono-storyforge#deployment)
...
[Permalink: License](https://github.com/tanner-griffith/phono-storyforge#license)

[Apache License 2.0](https://github.com/tanner-griffith/phono-storyforge/blob/main/LICENSE).

## About

Closed-loop adaptive reading tutor for early & struggling readers (dyslexia-aware), built on Google's ADK. Keeps a per-child mastery model, picks the next phonics skill from real reading evidence, generates a guaranteed-decodable book, listens to the read-aloud, attributes every miscue to its grapheme, and adapts the next book session over session.

### Topics

[agents-for-good](https://github.com/topics/agents-for-good) [bayesian-knowledge-tracing](https://github.com/topics/bayesian-knowledge-tracing) [dyslexia](https://github.com/topics/dyslexia) [education](https://github.com/topics/education) [gemini](https://github.com/topics/gemini) [google-adk](https://github.com/topics/google-adk) [kaggle](https://github.com/topics/kaggle) [mcp](https://github.com/topics/mcp) [phonics](https://github.com/topics/phonics) [reading-tutor](https://github.com/topics/reading-tutor)

### Resources

[Readme](https://github.com/tanner-griffith/phono-storyforge#readme-ov-file)

[Apache-2.0 license](https://github.com/tanner-griffith/phono-storyforge#Apache-2.0-1-ov-file)

[Activity](https://github.com/tanner-griffith/phono-storyforge/activity)

### Stars

[**0** stars](https://github.com/tanner-griffith/phono-storyforge/stargazers)

### Watchers

[**0** watching](https://github.com/tanner-griffith/phono-storyforge/watchers)

### Forks

[**0** forks](https://github.com/tanner-griffith/phono-storyforge/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Ftanner-griffith%2Fphono-storyforge&report=tanner-griffith+%28user%29)
