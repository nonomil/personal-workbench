...
test('english flashcards prefer local bitmap and play local audio when present', () => {
    ...
    assert.match(html, /preschool-english-vocab\.js\?v=20260815-english-auto-v1/);
    assert.match(html, /app\.js\?v=20260815-english-auto-v1/);
    assert.match(html, /35-course-flashcards\.css\?v=20260815-vocab-a1-v1|preschool-workbench\.css\?v=20260815-home-course-v1/);
});
