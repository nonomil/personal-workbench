# Preschool Pixel UI Asset Sheet B
...
Primary request: Create a clean 3 by 2 transparent-style sprite sheet containing six isolated original 16-bit pixel-art components for a preschool learning adventure dashboard: a tiny seedling in a soil patch, a cheerful yellow-orange potted flower checkpoint, a friendly small green tree, a cute cloud bug invader with a harmless smile, a round golden star companion pet with simple eyes, and a stone quest node pedestal with a colored flag.

Style/medium: original 16-bit pixel art, crisp nearest-neighbor edges, chunky dark pixel outlines, limited warm parchment / forest / sky palette, readable silhouettes at 72px, gentle and safe for ages 4-7. Keep every object fully visible with generous spacing and a small contained pixel shadow under each object.
...
Avoid: magenta, purple, pink petals, rainbow bands, Minecraft blocks, Plants vs. Zombies characters, branded game UI, photorealism, 3D clay, neon cyberpunk, scary monsters, gore, weapons, duplicate objects, cropped edges, merged objects, or accidental fragments.
